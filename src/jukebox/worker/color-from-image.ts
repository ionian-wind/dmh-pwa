...
export const getColor = (data: Data, args?: Partial<Args>) => getAverage(data, getArgs(args));
export const getPalette = (data: Data, args?: Partial<Args>) => getProminent(data, getArgs(args));
