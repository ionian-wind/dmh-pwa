...
import {inject, ref, onMounted, computed, watch, onBeforeUnmount, markRaw} from 'vue';
...
const setRightDrawerContent = inject('setRightDrawerContent') as (arg: any | null) => void
const setBottomDrawerContent = inject('setBottomDrawerContent') as (arg: any | null) => void
...
onMounted(async () => {
  ...
  setRightDrawerContent(PlaylistList);
  setBottomDrawerContent(JukeboxPlayer);
});
