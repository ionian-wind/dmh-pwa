...
<template>
  <div class="loading-examples">
    ...
    <Button :loading="isLoading" disabled> Disabled Loading </Button>
  </div>
</template>
...
<template>
  <div class="status-actions">
    <Button variant="success" @click="approve"> ✅ Approve </Button>
    <Button variant="warning" @click="review"> ⚠️ Review </Button>
    <Button variant="danger" @click="reject"> ❌ Reject </Button>
  </div>
</template>
```
